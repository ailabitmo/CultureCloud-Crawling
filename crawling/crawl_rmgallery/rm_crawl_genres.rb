...
gen_statement = lambda do |genre, object_id|
  ...
  object_uri = RDF::URI.new("http://culturecloud.ru/resource/object/#{object_id}")
  RDF::Statement(object_uri, @p2_has_type, genre_uri)
end

@genre_to_uri = {
    'абстракция' => gen_statement.curry.('http://culturecloud.ru/resource/thesauri/abstraction'),
    ...
    'иллюстрация' => gen_statement.curry.('http://culturecloud.ru/resource/thesauri/illustration'),
    'интерьер' => gen_statement.curry.('http://culturecloud.ru/resource/thesauri/abstraction'),
    'исторический сюжет' => gen_statement.curry.('http://collection.britishmuseum.org/id/thesauri/x12859'),
    'карикатура' => gen_statement.curry.('http://culturecloud.ru/resource/thesauri/caricature'),
    ...
    'портрет' => gen_statement.curry.('http://culturecloud.ru/resource/thesauri/portrait'),
    'театральная декорация' => gen_statement.curry.('http://culturecloud.ru/resource/thesauri/theatrical_scenery'),
}

@genres_hash = {
    'абстракция' => RDF::URI.new('http://culturecloud.ru/resource/thesauri/abstraction'),
    ...
    'иллюстрация' => RDF::URI.new('http://culturecloud.ru/resource/thesauri/illustration'),
    'интерьер' => RDF::URI.new('http://culturecloud.ru/resource/thesauri/abstraction'),
    'исторический сюжет' => RDF::URI.new('http://collection.britishmuseum.org/id/thesauri/x12859'),
    'карикатура' => RDF::URI.new('http://culturecloud.ru/resource/thesauri/caricature'),
    ...
    'портрет' => RDF::URI.new('http://culturecloud.ru/resource/thesauri/portrait'),
    'театральная декорация' => RDF::URI.new('http://culturecloud.ru/resource/thesauri/theatrical_scenery'),
}
